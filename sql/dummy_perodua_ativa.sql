...
SET @seller_id := 4;  -- TODO: change to a valid sellers.id

-- 1) Perodua Ativa (AV)
INSERT INTO cars
  (seller_id, make, model, variant, year, engine_capacity, mileage, transmission, price, fuel, drive_system, doors, listing_status)
VALUES
  (@seller_id, 'Perodua', 'Ativa', '1.0 Turbo AV', 2022, '1.0', 15000, 'CVT', 68000.00, 'Gasoline', 'FWD', 5, 'sold');
SET @car_id := LAST_INSERT_ID();
INSERT INTO car_images (car_id, image_path, is_thumbnail) VALUES
  (@car_id, 'uploads/ativa(1).webp', 1),
  (@car_id, 'uploads/ativa(2).webp', 0);
...
INSERT INTO cars
  (seller_id, make, model, variant, year, engine_capacity, mileage, transmission, price, fuel, drive_system, doors, listing_status)
VALUES
  (@seller_id, 'Perodua', 'Ativa', '1.0 Turbo X', 2021, '1.0', 28000, 'CVT', 62000.00, 'Gasoline', 'FWD', 5, 'sold');
SET @car_id := LAST_INSERT_ID();
INSERT INTO car_images (car_id, image_path, is_thumbnail) VALUES
  (@car_id, 'uploads/ativa(1).webp', 1),
  (@car_id, 'uploads/ativa(2).webp', 0);
...
INSERT INTO cars
  (seller_id, make, model, variant, year, engine_capacity, mileage, transmission, price, fuel, drive_system, doors, listing_status)
VALUES
  (@seller_id, 'Perodua', 'Ativa', '1.0 Turbo H', 2023, '1.0', 9000, 'CVT', 73500.00, 'Gasoline', 'FWD', 5, 'sold');
SET @car_id := LAST_INSERT_ID();
INSERT INTO car_images (car_id, image_path, is_thumbnail) VALUES
  (@car_id, 'uploads/ativa(1).webp', 1),
  (@car_id, 'uploads/ativa(2).webp', 0);
...
INSERT INTO cars
  (seller_id, make, model, variant, year, engine_capacity, mileage, transmission, price, fuel, drive_system, doors, listing_status)
VALUES
  (@seller_id, 'Perodua', 'Ativa', '1.0 Turbo SE', 2020, '1.0', 42000, 'CVT', 58500.00, 'Gasoline', 'FWD', 5, 'sold');
SET @car_id := LAST_INSERT_ID();
INSERT INTO car_images (car_id, image_path, is_thumbnail) VALUES
  (@car_id, 'uploads/ativa(1).webp', 1),
  (@car_id, 'uploads/ativa(2).webp', 0);
...
INSERT INTO cars
  (seller_id, make, model, variant, year, engine_capacity, mileage, transmission, price, fuel, drive_system, doors, listing_status)
VALUES
  (@seller_id, 'Perodua', 'Ativa', '1.0 Turbo S', 2024, '1.0', 3000, 'CVT', 76800.00, 'Gasoline', 'FWD', 5, 'sold');
SET @car_id := LAST_INSERT_ID();
INSERT INTO car_images (car_id, image_path, is_thumbnail) VALUES
  (@car_id, 'uploads/ativa(1).webp', 1),
  (@car_id, 'uploads/ativa(2).webp', 0);
